...
<html>
    ...
    <body>
        <form method="post" action="${pageContext.request.contextPath}/ServletReportes">
            ...
            <input type="submit" name="Ordenar" value="OrdenarMuebleMenosVendido">
            <table border="3">
                <thead>
                    <tr>
                        <td>ID FACTURA</td>
                ...
                <tbody>
                    <%
                        ...
                        if (request.getAttribute("FechaInicial") == null && request.getAttribute("FechaFinal") == null) {
                            ...
                            ventas = managerVenta.seleccionarVentasMuebleMenosVendido((String) request.getAttribute("FechaInicial"), (String) request.getAttribute("FechaFinal"));
                        }
            ...
            <%if (ventas.size() != 0) {
            %>
            <h1>MUEBLE MENOS VENDIDO: <%=ventas.get(0).getMuebleEnsamblado().getMueble().getNombreMueble()%></h1>
            <input type="submit" name="Ordenar" value="EXPORTAR_REPORTE_MUEBLE_MENOS_VENDIDO">
        </form>
        <%}%>
    </body>
</html>
